...
export default function ManagerDashboardView({ data }: ManagerDashboardViewProps) {
  ...
  // Pending Inter-site Transfer Requests State
  ...
  }, [activeTab, loadStorekeepers, loadWarehouses, loadPendingTransfers]);
      ...
      <main className="max-w-6xl mx-auto px-4 py-5 space-y-6">
        ...
        {activeTab === 'analytics' && (
          <div className="bg-slate-50/50 p-4 sm:p-7 rounded-3xl border border-slate-200/80 shadow-xs space-y-8 animate-in fade-in duration-300">
            ...
            {/* PENDING INTER-SITE TRANSFER REQUESTS */}
            <div className="bg-white border-2 border-indigo-200 rounded-3xl p-5 shadow-sm space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      בקשות שינוע כלי עבודה בין מחסנים ואתרים שהוגשו ע&quot;י מחסנאים מורשים
                    </p>
                  </div>
                </div>
              ...
              {pendingTransfers.length === 0 ? (
                <div className="p-6 text-center bg-slate-50/70 rounded-2xl border border-slate-200 text-xs font-bold text-slate-500 flex items-center justify-center gap-2">
                  ...
                  <span>אין כרגע בקשות העברה ממתינות לאישור &bull; כל הבקשות טופלו במלואן</span>
                </div>
              ) : (
